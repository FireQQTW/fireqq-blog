...
**Personal access tokens (PATs)** 是一個 Github 上可以用來當作使用者身分驗證的 auth token[建立 PATs](https://docs.github.com/en/github/authenticating-to-github/keeping-your-account-and-data-secure/creating-a-personal-access-token)，尤其是當你使用二階段驗證(2FA)時，在一些 Github API 和 command line 的操作，密碼就要換成 PATs 才能驗證成功。
...
```shell
## /Users/liuqq/.npmrc
//npm.pkg.github.com/:_authToken=<你的 GITHUB_PATS>
//npm.pkg.github.com/fireqq/:_authToken=<你的 GITHUB_PATS>
//registry.npmjs.org/:_authToken=<你的 NPM_TOKEN>
...
## 要讓 yarn 可以使用
//npm.pkg.github.com/:_authToken=<你的 GITHUB_PATS>
//npm.pkg.github.com/test-publish/:_authToken=<你的 GITHUB_PATS>
## 'npm.pkg.github.com/test-publish:_authToken=<你的 GITHUB_PATS>' yarn 還抓不到
